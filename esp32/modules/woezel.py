...
def get_pkg_metadata(name):
    f = url_open("https://badge.disobey.fi/eggs/get/%s/json" % name)
    try:
        return json.load(f)
    finally:
        f.close()
...
def get_pkg_list():
    f = url_open("https://badge.disobey.fi/eggs/list/json")
    try:
        return json.load(f)
    finally:
        f.close()
...
def search_pkg_list(query):
    f = url_open("https://badge.disobey.fi/eggs/search/%s/json" % query)
    try:
        return json.load(f)
    finally:
        f.close()
